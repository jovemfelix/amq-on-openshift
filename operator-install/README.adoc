...
spec:
  ...
  - amq-broker-operator.v7.11.0-opr-3
  generation: 1
```
...
To install a specific version of the operator theoretically we could use `startingCSV: amq-broker-operator.v7.11.0-opr-2` in the `Subscription`.
